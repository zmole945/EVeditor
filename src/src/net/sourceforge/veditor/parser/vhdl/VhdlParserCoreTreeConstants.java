...
public interface VhdlParserCoreTreeConstants
{
  ...
  public int JJTPACKAGE_INSTANTIATION_DECLARATION = 121;
  public int JJTPARAMETER_SPECIFICATION = 122;
  public int JJTPHYSICAL_LITERAL = 123;
  public int JJTPHYSICAL_TYPE_DEFINITION = 124;
  public int JJTPORT_CLAUSE = 125;
  public int JJTPORT_MAP_ASPECT = 126;
  public int JJTPREFIX = 127;
  public int JJTPROCEDURE_CALL = 128;
  public int JJTPROCEDURE_CALL_STATEMENT = 129;
  public int JJTPROCESS_DECLARATIVE_PART = 130;
  public int JJTPROCESS_STATEMENT = 131;
  ...
  public int JJTCONDITIONAL_FORCE_ASSIGNMENT = 149;
  public int JJTSELECTED_FORCE_ASSIGNMENT = 150;
  public int JJTSIMPLE_FORCE_ASSIGNMENT = 151;
  public int JJTSIMPLE_RELEASE_ASSIGNMENT = 152;
  public int JJTSIGNAL_ASSIGNMENT_STATEMENT = 153;
  public int JJTSIGNAL_DECLARATION = 154;
  public int JJTSIGNAL_KIND = 155;
  public int JJTSIGNAL_LIST = 156;
  public int JJTSIGNATURE = 157;
  public int JJTTERM = 158;
  public int JJTSLICE_NAME = 159;
  public int JJTSUBPROGRAM_BODY = 160;
  public int JJTSUBPROGRAM_DECLARATIVE_PART = 161;
  public int JJTSUBPROGRAM_SPECIFICATION = 162;
  public int JJTSUBPROGRAM_STATEMENT_PART = 163;
  public int JJTSUBTYPE_DECLARATION = 164;
  public int JJTSUBTYPE_INDICATION = 165;
  public int JJTFREE_QUANTITY_DECLARATION = 166;
  public int JJTBRANCH_QUANTITY_DECLARATION = 167;
  public int JJTSOURCE_QUANTITY_DECLARATION = 168;
  public int JJTACROSS_ASPECT = 169;
  public int JJTTHROUGH_ASPECT = 170;
  public int JJTSOURCE_ASPECT = 171;
  public int JJTTYPE_CONVERSION = 172;
  public int JJTUNCONSTRAINED_ARRAY_DEFINITION = 173;
  public int JJTUSE_CLAUSE = 174;
  public int JJTVARIABLE_ASSIGNMENT_STATEMENT = 175;
  public int JJTVARIABLE_DECLARATION = 176;
  public int JJTWAIT_STATEMENT = 177;
  public int JJTWAVEFORM = 178;
  public int JJTWAVEFORM_ELEMENT = 179;
  public int JJTSIMULTANEOUS_STATEMENT_PART = 180;
  public int JJTSIMPLE_SIMULTANEOUS_STATEMENT = 181;
  public int JJTSIMULTANEOUS_IF_STATEMENT = 182;
  public int JJTSIMULTANEOUS_CASE_STATEMENT = 183;
  public int JJTSIMULTANEOUS_ALTERNATIVE = 184;
  public int JJTSIMULTANEOUS_PROCEDURAL_STATEMENT = 185;
  public int JJTPROCEDURAL_DECLARATIVE_PART = 186;
  public int JJTPROCEDURAL_STATEMENT_PART = 187;
  public int JJTSIMULTANEOUS_NULL_STATEMENT = 188;
  public int JJTSHARED_VARIABLE_DECLARATION = 189;
  public int JJTERROR_SKIPTO = 190;
...
/* JavaCC - OriginalChecksum=2b3c81cdfbf3c7ccd942049f720a9b50 (do not edit this line) */
